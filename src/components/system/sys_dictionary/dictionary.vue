      ...
      <div style="width:98%;margin-left:1%;">
        <el-card class="box-card">
          ...
          <div class="grid-content bg-purple-light" :style="currentDivStyle">
            ...
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">编码：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="currentNodeData.code"></el-input>
              </el-col>
            ...
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">值1：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="currentNodeData.value"></el-input>
              </el-col>
              <el-col :span="4" class="col-left">值2：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="currentNodeData.extend"></el-input>
              </el-col>
            </el-row>
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">描述：</el-col>
              <el-col :span="20">
                <el-input type="textarea" :rows="2" placeholder="" v-model="currentNodeData.description"></el-input>
              </el-col>
            </el-row>
            <el-row :gutter="20" class="my-row">
        ...
        <el-card class="box-card" style="margin-top: 10px;" v-show="showChildRow">
          ...
          <div class="grid-content bg-purple-light" style="height: calc(50vh - 280px);font-size:14px;">
            ...
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">编码：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="childNodeData.code"></el-input>
              </el-col>
              <el-col :span="4" class="col-left">名称：</el-col>
              <el-col :span="8">
            ...
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">值1：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="childNodeData.value"></el-input>
              </el-col>
              <el-col :span="4" class="col-left">值2：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="childNodeData.extend"></el-input>
              </el-col>
            </el-row>
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">描述：</el-col>
              <el-col :span="20">
                <el-input type="textarea" :rows="2" placeholder="" v-model="childNodeData.description"></el-input>
              </el-col>
            </el-row>
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">&nbsp;</el-col>
        ...
        <el-card class="box-card" style="margin-top: 10px;" v-show="showBotherRow">
          ...
          <div class="grid-content bg-purple-light" style="height: calc(50vh - 280px);font-size:14px;">
            ...
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">编码：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="botherNodeData.code"></el-input>
              </el-col>
              <el-col :span="4" class="col-left">名称：</el-col>
              <el-col :span="8">
            ...
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">值1：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="botherNodeData.value"></el-input>
              </el-col>
              <el-col :span="4" class="col-left">值2：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="botherNodeData.extend"></el-input>
              </el-col>
            </el-row>
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">描述：</el-col>
              <el-col :span="20">
                <el-input type="textarea" :rows="2" placeholder="" v-model="botherNodeData.description"></el-input>
              </el-col>
            </el-row>
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">&nbsp;</el-col>
...
export default {
  ...
  methods: {
    ...
    resetCurrentNodeData(){
      ...
      this.currentNodeData.code = '';
      this.currentNodeData.label = '';
      this.currentNodeData.description = '';
      this.currentNodeData.value = '';
      this.currentNodeData.extend = '';
      this.currentNodeData.children = [];
    },
    resetChildNodeData(){
      this.childNodeData.id = '';
      this.childNodeData.parentId = '';
      this.childNodeData.code = '';
      this.childNodeData.label = '';
      this.childNodeData.description = '';
      this.childNodeData.value = '';
      this.childNodeData.extend = '';
      this.childNodeData.children = [];
    },
    resetBotherNodeData(){
      this.botherNodeData.id = '';
      this.botherNodeData.parentId = '';
      this.botherNodeData.code = '';
      this.botherNodeData.label = '';
      this.botherNodeData.description = '';
      this.botherNodeData.value = '';
      this.botherNodeData.extend = '';

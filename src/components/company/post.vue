      ...
      <div style="width:98%;margin-left:1%;">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span style="font-size: 16px;"><i class="el-icon-menu"></i>&nbsp;岗位</span>
          </div>
        ...
        <el-card class="box-card">
          ...
          <div class="grid-content bg-purple-light" :style="currentDivStyle">
            <el-row :gutter="20" class="my-row">
              ...
              <el-col :span="4" class="col-left">父组织ID：</el-col>
              <el-col :span="8">
            ...
            <el-row :gutter="20" class="my-row">
              ...
              <el-col :span="20" style="text-align:left;">
                <el-tooltip class="item" effect="dark" content="点击“子节点”按钮，展开或关闭新增子节点的页面" placement="bottom">
                  <el-button size="small" plain icon="el-icon-arrow-down" v-if="!showChildRow && currentNodeData.level > 0" @click="showChildRowClick" :loading="winBtnLoading">子节点</el-button>
                  <el-button type="success" size="small" icon="el-icon-arrow-up" v-if="showChildRow && currentNodeData.level > 0"  @click="showChildRowClick" :loading="winBtnLoading">子节点</el-button>
                </el-tooltip>
                <el-tooltip class="item" effect="dark" content="点击“兄弟节点”按钮，展开或关闭新增兄弟节点的页面" placement="bottom" v-if="currentNodeData.id != 0">
                  <el-button size="small" plain icon="el-icon-arrow-down" v-if="!showBotherRow && currentNodeData.level > 1" @click="showBotherRowClick" :loading="winBtnLoading">兄弟节点</el-button>
                  <el-button type="success" size="small" icon="el-icon-arrow-up" v-if="showBotherRow && currentNodeData.level > 1"  @click="showBotherRowClick" :loading="winBtnLoading">兄弟节点</el-button>
                </el-tooltip>
        ...
        <el-card class="box-card" style="margin-top: 10px;" v-show="showChildRow">
          ...
          <div class="grid-content bg-purple-light" style="height: calc(50vh - 240px);font-size:14px;">
            <el-row :gutter="20" class="my-row">
              ...
              <el-col :span="4" class="col-left">父组织ID：</el-col>
              <el-col :span="8">
                <el-input suffix-icon="el-icon-edit-outline" clearable v-model="childNodeData.orgId" disabled></el-input>
              </el-col>
            </el-row>
            <el-row :gutter="20" class="my-row">
              <el-col :span="4" class="col-left">级别：</el-col>
  ...
  export default {
    ...
    methods: {
      ...
      initTree(){
        ...
        that.$AJAX.GET(this, 'tOrg/getTree', null, function(response){
      ...
      showChildRowClick(){
        ...
        this.childNodeData.orgId = this.currentNodeData.id;
      ...
      showBotherRowClick(){
        ...
        this.botherNodeData.orgId = this.currentNodeData.parentId;
      ...
      saveChildNodeData(){
        ...
        that.$AJAX.POST(that, that.childNodeData, that.fn + '/save', true, function(response){
          that.initTree();
          that.expandNode(that.childNodeData.orgId);
        });
      },
      saveBotherNodeData(){
        var that = this;
        that.$AJAX.POST(that, that.botherNodeData, that.fn + '/save', true, function(response){
          that.initTree();
          that.expandNode(that.botherNodeData.orgId);
        });
      },
      updateNode(){
        var that = this;
        that.$AJAX.PUT(that, that.currentNodeData, that.fn + '/update', function(response){
          that.initTree();
          that.expandNode(that.currentNodeData.orgId);
        });
      },
      deleteCheckedKeys(){
